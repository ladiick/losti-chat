        ...
        <div onClick={handlerPeople} className={s.block__people__item}>
          <div className={s.info__message}>
            {firstName === "Избранное" ? (
              ...
              <EmptyImage style={{ width: 45, height: 45, marginRight: 10 }} noOnline={online} index={index} image={img} name={{ firstName, lastName }} />
            )}
            <div className={s.name__lastMessage}>
              <Text weight="strong" style={{ cursor: "pointer" }}>
                {firstName} {lastName}
              </Text>
            </div>
          </div>
  ...
  return (
    <div className={s.main__wrapper} title={firstName + " " + lastName}>
      <div onClick={handlerPeople} className={classPeopleItem}>
        <div className={s.info__message}>
          {firstName === "Избранное" ? <img src={img} alt="" /> : <EmptyImage noOnline={online} style={{ width: 45, height: 45 }} index={index} image={img} name={{ firstName, lastName }} />}

          <div className={s.name__lastMessage}>
            <Text weight="strong" style={{ cursor: "pointer" }}>
              {firstName} {lastName}
            </Text>
            <Text className={s.last__message} style={{ cursor: "pointer" }}>
              {message}
            </Text>
          </div>
